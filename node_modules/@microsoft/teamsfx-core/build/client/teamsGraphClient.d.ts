...
export declare class TEAMS_GRAPH_API_NAMES {
...
export declare class TeamsGraphClient {
    getEndpoint(): string;
    ...
    getApiKeyRegistrationById(token: string, apiKeyRegistrationId: string): Promise<ApiSecretRegistration>;
...
export declare const teamsGraphClient: TeamsGraphClient;
//# sourceMappingURL=teamsGraphClient.d.ts.map